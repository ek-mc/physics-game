...
function genKinematicsAdvanced(){
  ...
  out.push(makeQuestion('kinematics','hard',
    'Δίσκος περιστρέφεται γύρω από σταθερό άξονα που περνά από το κέντρο του, με σταθερή γωνιακή ταχύτητα. Ποιο μέγεθος είναι σταθερό και μη μηδενικό;',
  ...
  out.push(makeQuestion('kinematics','hard',
    'Στην ίδια κίνηση (σταθερή γωνιακή ταχύτητα), ποιο μέγεθος είναι μηδενικό;',
...
function genIdeaProblems(){
  ...
  const kin = [
    ...
    ['Στην ίδια κίνηση (σταθερή γωνιακή ταχύτητα), ποιο μέγεθος είναι μηδενικό;', ['α','ω','θ','τ'],0,'Αφού η ω δεν μεταβάλλεται με τον χρόνο, α=dω/dt=0.'],
    ['Τρένο κινείται σε ράγες με σταθερή επιτάχυνση και διανύει γνωστή απόσταση μεταξύ δύο σταθμών. Χωρίς να δίνεται ο χρόνος t, ποια εξίσωση είναι η πιο κατάλληλη για να βρεθεί η τελική ταχύτητα v;', ['v²=v₀²+2aΔx','v=v₀+at','x=x₀+vt','P=dW/dt'],0,'Όταν λείπει ο χρόνος, πάμε σε v²=v₀²+2aΔx.'],
