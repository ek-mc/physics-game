...
function genIdeaProblems(){
  ...
  const dyn = [
    ['Ανελκυστήρας κινείται με σταθερή ταχύτητα. Ποια σχέση ισχύει για ττη συνισταμένη;', ['ΣF=0','ΣF=ma με a>0','ΣF=mg','ΣF=T'],0,'Σταθερή ταχύτητα ⇒ a=0 ⇒ ΣF=0.'],
    ['Ένα όχημα δέχεται δύο αντίθετες οριζόντιες δυνάμεις (μία προς τα δεξιά και μία προς τα αριστερά). Ποια δύναμη καθορίζει τη φορά της επιτάχυνσης;', ['Ττη συνισταμένη (δηλαδή ποια δύναμη υπερισχύει)','Τη μάζα μόνο','Το βάρος','Την αρχική ταχύτητα'],0,'Η επιτάχυνση έχει φορά ττη συνισταμένης δύναμης.'],
