...
function genIdeaProblems(){
  ...
  const dyn = [
    ...
    ['Ένα όχημα δέχεται δύο αντίθετες οριζόντιες δυνάμεις (μία προς τα δεξιά και μία προς τα αριστερά). Ποια δύναμη καθορίζει τη φορά της επιτάχυνσης;', ['Τη συνισταμένη (δηλαδή ποια υπερισχύει)','Τη μάζα μόνο','Το βάρος','Την ταχύτητα αρχικά'],0,'Η επιτάχυνση έχει φορά τη συνισταμένης δύναμης.'],
