...
function genIdeaProblems(){
  ...
  const kin = [
    ...
    ['Ρολόι: ο δείκτης δευτερολέπτων έχει σταθερή γωνιακή ταχύτητα. Τι είναι σταθερό;', ['ω','α','θ','τ'],0,'Σε ομαλή περιστροφή: σταθερή ω, μηδενική α.'],
  ...
  const dyn = [
    ...
    ['Όχημα με δύο αντίθετες δυνάμεις. Η φορά του a καθορίζεται από:', ['Τη μεγαλύτερη δύναμη','Τη μάζα μόνο','Το βάρος','Την ταχύτητα αρχικά'],0,'Η επιτάχυνση έχει φορά τη συνισταμένης δύναμης.'],
    ...
    ['Σε οριζόντιο χωρίς τριβή, γιατί N=mg;', ['Δεν υπάρχει κατακόρυφη επιτάχυνση','Επειδή m=1','Επειδή δεν υπάρχει F','Επειδή v=0'],0,'Στον y άξονα: ΣFy=0 ⇒ N=mg (αν αυτές είναι οι μόνες κατακόρυφες).'],
    ['Τριβή ολίσθησης συνήθως γράφεται:', ['f=μN','f=ma','f=mg','f=μm'],0,'Μοντέλο: f=μN.']
  ];
