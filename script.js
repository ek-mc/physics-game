...
function genIdeaProblems(){
  ...
  const kin = [
    ...
    ['Σε πρόβλημα με τρένο όπου δεν δίνεται ο χρόνος t, ποια εξίσωση είναι η πιο κατάλληλη για να βρεις την τελική ταχύτητα v;', ['v²=v₀²+2aΔx','v=v₀+at','x=x₀+vt','P=dW/dt'],0,'Όταν λείπει ο χρόνος, πάμε σε v²=v₀²+2aΔx.'],
